export const BSC_PERMISSIONS = {
  ...
  REQUEST_REOPEN: 'bsc.reopen.request', REVIEW_REOPEN: 'bsc.reopen.subordinate', RESET_APPROVED: 'bsc.reset.approved', VIEW_VERSION: 'bsc.version.view', DUPLICATE_OWN: 'bsc.duplicate.own',
