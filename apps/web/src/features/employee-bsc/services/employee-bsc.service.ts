...
export const employeeBscApi = {
  ...
  approveReopen: (requestId: string, reason?: string) => httpClient.post<BscReopenRequest>(`/employee-bsc/reopen-requests/${requestId}/approve`, { reason }),
  ...
  resetApprovedPlan: (id: string, reason: string) => httpClient.post<BscReopenRequest>(`/employee-bsc/${id}/plan/reset-approved`, { reason }),
  resetApprovedEvaluation: (id: string, reason: string) => httpClient.post<BscReopenRequest>(`/employee-bsc/${id}/evaluation/reset-approved`, { reason }),
  ...
  approvePlan: (id: string, reason?: string) => httpClient.post<EmployeeBsc>(`/employee-bsc/${id}/plan/approve`, { reason }),
  ...
  approveEvaluation: (id: string, reason?: string) => httpClient.post<EmployeeBsc>(`/employee-bsc/${id}/evaluation/approve`, { reason }),
