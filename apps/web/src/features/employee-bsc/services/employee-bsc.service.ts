...
export const employeeBscApi = {
  ...
  submit: (id: string) => httpClient.post<EmployeeBsc>(`/employee-bsc/${id}/submit`, {}),
  approve: (id: string) => httpClient.post<EmployeeBsc>(`/employee-bsc/${id}/approve`, {}),
  return: (id: string, reason: string) => httpClient.post<EmployeeBsc>(`/employee-bsc/${id}/return`, { reason }),
