...
const evaluationStatuses = [{ value: 'NOT_STARTED', label: 'Chưa bắt đầu' }, { value: 'DRAFT', label: 'Đang tự đánh giá' }, { value: 'SUBMITTED', label: 'Chờ duyệt kết quả' }, { value: 'RETURNED', label: 'Bị trả lại' }, { value: 'APPROVED', label: 'Đã duyệt' }];
