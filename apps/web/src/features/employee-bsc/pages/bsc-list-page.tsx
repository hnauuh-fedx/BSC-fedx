...
const REVIEW_PERMISSIONS = [BSC_PERMISSIONS.APPROVE_PLAN_SUBORDINATE, BSC_PERMISSIONS.RETURN_PLAN_SUBORDINATE,
...
export const BscListPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    employeeBscApi.list({ search, planStatus, evaluationStatus, page, limit: 20, sortBy: 'created_at', sortOrder: 'desc' })
