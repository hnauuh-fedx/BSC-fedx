...
export const BscDetailPage: React.FC = () => {
  ...
  return <main>
    ...
    {bsc.plan_status === 'APPROVED' && (scoringLoading ? <LoadingState/> : scoringError ? <><ErrorState error={scoringError}/><button onClick={() => void loadScoring()}>Thử tải lại điểm</button></> : scoring && <BscScoreSummary preview={scoring}/>)}
