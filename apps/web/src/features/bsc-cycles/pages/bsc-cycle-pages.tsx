...
export const BscCycleDetailPage: React.FC = () => {
  ...
  const summary = cycle.summary ? { 'Tổng BSC': cycle.summary.totalBsc, 'Chưa tạo': cycle.summary.notCreated, 'Nháp': cycle.summary.draft, 'Chờ duyệt kế hoạch': cycle.summary.planSubmitted, 'Kế hoạch đã duyệt': cycle.summary.planApproved, 'Đang đánh giá': cycle.summary.evaluating, 'Chờ duyệt đánh giá': cycle.summary.evaluationSubmitted, 'Đánh giá đã duyệt': cycle.summary.evaluationApproved, 'Kế hoạch bị trả lại': cycle.summary.planReturned, 'Đánh giá bị trả lại': cycle.summary.evaluationReturned } : null;
