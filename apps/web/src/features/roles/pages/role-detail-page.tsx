...
const PERMISSION_CODE_LABELS: Record<string, string> = {
  ...
  'bsc.submit.plan.own': 'Nộp giai đoạn PLAN',
  'bsc.submit.evaluation.own': 'Nộp giai đoạn EVALUATION',
  'bsc.update.actual.own': 'Cập nhật kết quả thực hiện',
  'bsc.plan.approve.subordinate': 'Duyệt PLAN cấp dưới',
  'bsc.plan.return.subordinate': 'Trả lại PLAN cấp dưới',
  'bsc.evaluation.approve.subordinate': 'Duyệt EVALUATION cấp dưới',
  'bsc.evaluation.return.subordinate': 'Trả lại EVALUATION cấp dưới',
