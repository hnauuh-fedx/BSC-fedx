...
const messages: Record<string, string> = {
  ...
  AUTH_CURRENT_PASSWORD_INVALID: 'Mật khẩu hiện tại không chính xác.', AUTH_NEW_PASSWORD_SAME: 'Mật khẩu mới phải khác mật khẩu hiện tại.',
  AUTH_PASSWORD_POLICY_VIOLATION: 'Mật khẩu mới phải có từ 12 đến 128 ký tự.', AUTH_PASSWORD_RATE_LIMITED: 'Bạn đã thử quá nhiều lần. Vui lòng thử lại sau.',
  USER_INVALID_DEPARTMENT: 'Đơn vị không hợp lệ hoặc đã ngừng hoạt động.', USER_INVALID_POSITION: 'Chức danh không hợp lệ hoặc đã ngừng hoạt động.', USER_INVALID_ROLE: 'Vai trò không hợp lệ hoặc đã ngừng hoạt động.', USER_ROLE_PERMISSION_ESCALATION: 'Không thể gán vai trò có quyền vượt quá quyền của bạn.', USER_INVALID_MANAGER: 'Quản lý trực tiếp không hợp lệ.', USER_MANAGER_CYCLE: 'Quan hệ quản lý tạo thành vòng lặp.', USER_LAST_ACTIVE_ADMIN: 'Không thể khóa ADMIN khả dụng cuối cùng.',
...
export const httpClient = {
  ...
  put: <T>(path: string, body: unknown) => execute<T>(path, { method: 'PUT', body: JSON.stringify(body) }),
